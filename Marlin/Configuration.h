 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.05 // (mm) Distance from real junction edge (based on 0.4x10x10/800)
...
//#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_BRIGHTNESS 31  // Initial brightness (0-255)
